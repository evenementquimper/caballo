...
.controller('MyCtrl', ['$scope', '$http', 'Upload', '$window', function($scope, $http, Upload, $window) {
    ...
    vm.upload = function(file) {
        ...
        Upload.upload({
            url: 'http://localhost:3000/article/upload', //webAPI exposed to upload the file
            data: {
                file: file
            ...
            //    console.log('RespConfig' + resp);
              ...
              //  $http.put('/article' + $scope.advert._id, $scope.advert).success(function(response) {
